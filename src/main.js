const { app, BrowserWindow, screen, clipboard, dialog, autoUpdater } = require('electron');
...
app.on('ready',()=>{
    createSplashWindow()
    autoUpdater.checkForUpdatesNotify()
})
...
function createGameWindow(url, webContents) {
    ...
    shortcuts.register(game, 'F12', () => console.log("F12"));
